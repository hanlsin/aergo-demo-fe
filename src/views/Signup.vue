<template>
  <div class="signup">
    <h3>Sign up</h3>
    <form ref="form">
      <input placeholder="Enter your name" v-model="username"
        class="input-box">
      <input placeholder="Enter your email (optional)" v-model="userEmail"
        class="input-box">
      <input placeholder="Enter new password" v-model="password"
        type="password" class="input-box">
      ...
      <a href="#" v-on:click="submit"
        class="btn btn-primary rounded-pill">Sign up</a>
      <router-link :to="{ name: 'login', params: {} }"
        class="btn btn-outline-primary rounded-pill">Login</router-link>
